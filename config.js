...
const SUDO = process.env.SUDO || '263716394979';
...
const BOT_INFO = process.env.BOT_INFO || "MR-ONLINE-MD;TCRONEB HACKX;https://i.imgur.com/r3GZeiX.jpeg";
...
const STICKER_DATA = process.env.STICKER_DATA || "MR~ONLINE~MD";
